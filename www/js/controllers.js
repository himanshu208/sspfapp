angular.module('sspf.controllers', [])
    ...
    //LOGIN
    .controller('LoginCtrl', function($scope, $http, $state,$ionicLoading, $templateCache, $q, $rootScope) {
        $scope.doLogIn = function(){
            ...
            .success(function (response) {
                ...
                if(response.login===true && response.email==$scope.user.email){
    ...
    .controller('FeedsCategoriesCtrl', function($scope,$state, $http) {
...
function isLogedin($state){
    var isLogedin = window.localStorage.getItem("authtoken"); //alert(isLogedin);
